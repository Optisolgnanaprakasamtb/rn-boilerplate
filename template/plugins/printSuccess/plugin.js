...
module.exports = {
	async apply(value, previousValues) {
		return new Promise(resolve => {
			...
			console.log(
				'- 📚 If you need to read more about this boilerplate : https://github.com/Optisolgnanaprakasamtb/rn-boilerplate'
			);
			console.log(
				'- 🤕 If you have some troubles : https://github.com/Optisolgnanaprakasamtb/rn-boilerplate/issues'
			);
			console.log(
				'- ⭐ If you love this boilerplate, give us a star, you will be a ray of sunshine in our lives :) https://github.com/Optisolgnanaprakasamtb/rn-boilerplate'
			);
