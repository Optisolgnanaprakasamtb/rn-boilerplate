...
_Just navigate to the [project home page](https://github.com/Optisolgnanaprakasamtb/rn-boilerplate) if you want to see more._
...
- [ ] Use the right [.gitignore](https://github.com/Optisolgnanaprakasamtb/rn-boilerplate/blob/master/template/ios/.gitignore) file inside the `ios` directory
...
- [ ] Use the right [.gitignore](https://github.com/Optisolgnanaprakasamtb/rn-boilerplate/blob/master/template/android/.gitignore) file inside the `android` directory (if you are using this boilerplate you are good to go)
